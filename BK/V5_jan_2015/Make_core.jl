...
nfisher_max = false #optimal clique size when VOI high
nfisher_min = false #optimal clique size when VOI low
nfisher_ts = false #optimal clique size when VOI low
nfisher_quantile = true #optimal clique size when VOI high
