...
const PC_v    = .2; # speed of fishers (km per time)
const PC_ff   = 10; # radius of fish finder (km)
const PC_c    = 1; # distance at which fishers can catch fish (km)
const PC_rn   = .5; # correlated random walk randomness
const PC_pr   = 1.; # probability of catching fish once encountered

##### Cluster parameters
const PCL_n   = 2;    # number of cluster centres
const PCL_p   = 0.001; # probability that cluster center will move
