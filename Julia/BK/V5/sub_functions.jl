...
function fnc_harvest(KK,JJ,CC,Tau_n,Tau_s,
                       Tau_t,Tau_dmu,Tau_mu,Tau_M,Tau_S,Tau_s2,Tau_ds2,FF)
    II = KK.*JJ
    if II != 0 # if the fish is caught
        ...
        # keep running statistics the same
    ...
    return CC,tau_n,tau_s,tau_t,tau_mu,tau_M,tau_S,tau_s2,tau_dmu,tau_ds2,FF
end
